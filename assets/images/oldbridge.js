...
(function(){
	...
	var Bridge0 = {
		...
		runFileDialog: function(caption, dir, filter, callback_path){
			var path = _Bridge_.openFileDialog(caption,dir,filter);
			callback_path(path);
		},
		...
		runImgFileDialog: function(caption, dir, options, callback){
			...
			Bridge.runFileDialog(caption,dir,"Images (*.jpg *.jpeg *.png *.gif *.bmp *.tiff *.svg)", function(path){
